...
public class JEvaluatorTest
{
	...
	System.out.println("Evaluated text: "
 ...
 expr.setExpr("orTest=or(len,average)");
        ...
        expr.setExpr("bitwiseANDtest=15&20");
        System.out.println("15&20: " + expr.getVar("bitwiseANDtest"));

        expr.setExpr("bitwiseIncORtest=15|20");
        System.out.println("15|20: " + expr.getVar("bitwiseIncORtest"));

        expr.setExpr("bitwiseExcORtest=15!20");
        System.out.println("15!20: " + expr.getVar("bitwiseExcORtest"));
    }
}

 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class RoundDown implements BaseFunctionInterface
{
    /**
     * Rounds down the value of the given parameter: rounddown(x)
     */
    public String compute(List p)
    {
        return Double.toString(java.lang.Math.floor(Double
                .parseDouble((String)p.get(0))));
    }
